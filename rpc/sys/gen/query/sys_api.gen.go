...
func newSysAPI(db *gorm.DB, opts ...gen.DOOption) sysAPI {
	...
	_sysAPI.Handle = field.NewString(tableName, "handle")
	_sysAPI.Title = field.NewString(tableName, "title")
	_sysAPI.Path = field.NewString(tableName, "path")
	_sysAPI.Type = field.NewString(tableName, "type")
	_sysAPI.Action = field.NewString(tableName, "action")
...
type sysAPI struct {
	...
	Path      field.String // 地址
	Type      field.String // 接口类型
	Action    field.String // 请求类型
